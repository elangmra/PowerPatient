...
<div class="col-12 col-xl-9">
    ...
    <div class="content">
        <div class="row">
            <div class="col-12">
                <h2 class="content-title">Form Pendaftaran</h2>
                <h5 class="content-desc mb-4">Input Data Pasien Baru</h5>
            </div>
                    ...
                    <form action="formController.php" method="post" >
                        <table rules="none">
                            <tr>
                                ...
                                <td>:</td>
                                <td ><input type="datetime-local" name="tanggaldaftar" class="form-control"></td>
                            </tr>
                            <tr>
                                <td width="300px" height="50px">NIK</td>
                                <td>:</td>
                                <td><input type="text" name="nik" class="form-control" placeholder="Masukan NIK" /></td>
                            </tr>
                            <tr>
                                <td width="300px" height="50px">Nama Lengkap</td>
                                <td>:</td>
                                <td><input type="text" name="namaLengkap" class="form-control" placeholder="Masukan Nama Lengkap" /></td>
                            </tr>
                            <tr>
                                <td width="300px" height="50px">Tempat Lahir</td>
                                <td>:</td>
                                <td><input type="text" name="tempatLahir" class="form-control" placeholder="Masukan Tempat Lahir" /></td>
                            </tr>
                            <tr>
                                <td width="300px" height="50px">Tanggal Lahir</td>
                                <td>:</td>
                                <td><input type="date" name="tanggalLahir" class="form-control" placeholder="Masukan Tanggal Lahir" /></td>
                            </tr>
                            <tr>
                                <td width="300px" height="50px">Jenis Kelamin</td>
                                <td>:</td>
                                <td><select name="gender" placeholder="Silakan Pilih">
                            <!--  <option value="">Silakan Pilih!</option> -->
                                ...
                                <td>:</td>
                                <td><input type="text" name="kepalaKeluarga" class="form-control" placeholder="Masukan Nama Kepala Keluarga" /></td>
                            </tr>
                            </tr>
                                <td width="300px" height="50px">Alamat</td>
                                <td>:</td>
                                <td><input type="text" name="alamat" class="form-control" placeholder="Masukan Alamat Lengkap" /></td>
                            </tr>
                            </tr>
                                <td width="300px" height="50px">No. HP</td>
                                <td>:</td>
                                <td> <input type="tel" class="nohp" placeholder="Masukan No HP" name="phone" />
                            </tr>
                            </tr>
                                <td width="300px" height="50px">Agama</td>
                                <td>:</td>
                                <td><select name="agama" placeholder="Silakan Pilih">
                            <!--  <option value="">Silakan Pilih!</option> -->
                                ...
                                <td>:</td>
                                <td> <select name="pendidikan" placeholder="Silakan Pilih">
                            <!--  <option value="">Silakan Pilih!</option> -->
                                ...
                                <td>:</td>
                                <td><select name="golonganDarah" placeholder="Silakan Pilih">
                            <!--  <option value="">Silakan Pilih!</option> -->
                                ...
                                <td>:</td>
                                <td> <input type="text" name="pekerjaan" class="form-control" placeholder="Masukan Pekerjaan" /></td>
                            </tr>
                            </tr>
                                <td width="300px" height="50px">Status Nikah</td>
                                <td>:</td>
                                <td>   <select name="statusNikah" placeholder="Silakan Pilih">
                            <!--  <option value="">Silakan Pilih!</option> -->
                                ...
                                <td>:</td>
                                <td><select name="paymentOpt" placeholder="Silakan Pilih">
                            <!--  <option value="">Silakan Pilih!</option> -->
                                ...
                                <td>:</td>
                                <td> <input type="textarea" name="dihubungi" placeholder="Masukkan Nama dan NO.HP"></td>
                            </tr>
