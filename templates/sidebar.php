...
<aside class="sidebar">
    ...
    <h5 class="sidebar-title">Feature</h5>

    <a href="./dashboard.php" class="sidebar-item <?= ($is_active== 1) ? 'active' : '' ?>" onclick="toggleActive(this)">
    ...
    <a href="./form.php" class="sidebar-item <?= ($is_active== 2) ? 'active' : '' ?>" onclick="toggleActive(this)">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="./settings.php" class="sidebar-item <?= ($is_active== 3) ? 'active' : '' ?>" onclick="toggleActive(this)">
